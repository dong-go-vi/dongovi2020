...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-xs-9 d-inline-block">
			<div class="card w-100 mb-4 py-0 border-left-primary">
				<div class="card-body py-2">
					<form class="form-inline d-inline-block" role="form" id="teamSelect">
						<div class="form-group pr-3">
							<label for="selTeam" class="font-weight-bold text-primary pr-2">
									팀
							</label>
							<select class="form-control small" id="selTeam">
					...
					<form class="form-inline d-inline-block" role="form" id="teacherSelect">
						<div class="form-group pr-3">
							<label for="selTeam" class="font-weight-bold text-primary pr-2">
									교사
							</label>
					...
					<form class="form-inline d-inline-block" role="form" id="yearSelect">
						<div class="form-group pr-3">
							<label for="selTeam" class="font-weight-bold text-primary pr-2">
								연도
							</label>
					...
					<form class="form-inline d-inline-block" role="form" id="monthSelect">
		...
		<!-- 버튼 영역 -->
		<div class="col-md-3 d-inline-block float-right">
			<div class="card w-100 mb-4 py-1 border-left-primary">
