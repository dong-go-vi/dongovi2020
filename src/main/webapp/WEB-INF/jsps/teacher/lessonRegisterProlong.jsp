			...
			<form id="" class="form-inline" role="form">
				<table class="table table-bordered initialism">
					...
					<tr>
						...
						<td class="p-2">
							...
							<select id="lessonForm">
								<option>전체</option>
								<option selected>생태</option>
								<option>특강</option>
							</select>
							<label for="studentCount" class="d-inline-block font-weight-bold text-primary pl-3">
								인원
							</label>
							<input id="studentCount" type="text" style="width:60px;" value=6>
						</td>
					...
					<tr>
						...
						<td class="p-2">
							<input id="" type="text" class="ml-3" style="width:100px;" value=720000>
						</td>
						...
						<td class="p-2 align-middle">
							<input id="" class="ml-3" type="text" style="width:100px;" value=90000>
							<label for="updateUnitLecFee" class="d-inline-block font-weight-bold text-primary pl-3">
								수정
							</label>
							<input id="updateUnitLecFee" type="text" style="width:100px;" value=0>
						</td>
					</tr>
					<tr>
				...
				<table class="table table-bordered initialism text-center">
					<tr>
						...
						<td class="p-0 align-middle text-dark">
							<input class="ml-3" type="text" style="width:100px"
							 value="김학생">
						</td>
